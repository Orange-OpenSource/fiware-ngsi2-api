...
public class IncompatibleParameterExceptionTest {
    ...
    public void checkProperties() {
        ...
        assertEquals("error: 400 | description: The incoming request is invalid in this context. The parameter id is incompatible with idPattern in List entities operation. | affectedItems: []", exception.getMessage());
    }
}
